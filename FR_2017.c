...
void DrawPlot(TH1F* qcd, TH1F* Wjets, TH1F* Zjets, TH1F* ttbar, TH1F* WW, TH1F* WZ, TH1F* ZZ, TH1F* tW, TH1F* Wantitop, TH1F* dy, TH1F* DATA, THStack* DATA_MC, TString title, TString name, bool logx);

void RatePlot(TH1F* Wjets_den, TH1F* Zjets_den, TH1F* ttbar_den, TH1F* WW_den, TH1F* WZ_den, TH1F* ZZ_den, TH1F* tW_den, TH1F* Wantitop_den, TH1F* dy_den, TH1F* Data_den, TH1F* Wjets_num, TH1F* Zjets_num, TH1F* ttbar_num, TH1F* WW_num, TH1F* WZ_num, TH1F* ZZ_num, TH1F* tW_num, TH1F* Wantitop_num, TH1F* dy_num, TH1F* qcd_den, TH1F* qcd_num, TH1F* Data_num, TString title, TString name);

void QCDPlot(TH1F* qcd_den, TH1F* qcd_num, TString name);

//void EWKPlot(TH1F* Wjets_den, TH1F* Zjets_den, TH1F* ttbar_den, TH1F* WW_den, TH1F* WZ_den, TH1F* ZZ_den, TH1F* tW_den, TH1F* Wantitop_den, TH1F* dy_den, TH1F* Wjets_num, TH1F* Zjets_num, TH1F* ttbar_num, TH1F* WW_num, TH1F* WZ_num, TH1F* ZZ_num, TH1F* tW_num, TH1F* Wantitop_num, TH1F* dy_num, TString title, TString name);

//void calRate(TH1F* Wjets_den, TH1F* Zjets_den, TH1F* ttbar_den, TH1F* WW_den, TH1F* WZ_den, TH1F* ZZ_den, TH1F* tW_den, TH1F* Wantitop_den, TH1F* dy_den, TH1F* Data_den, TH1F* Wjets_num, TH1F* Zjets_num, TH1F* ttbar_num, TH1F* WW_num, TH1F* WZ_num, TH1F* ZZ_num, TH1F* tW_num, TH1F* Wantitop_num, TH1F* dy_num, TH1F* Data_num, TString name);

//void DrawHist(TH1F* qcd, TH1F* Wjets, TH1F* Zjets, TH1F* ttbar, TH1F* WW, TH1F* WZ, TH1F* ZZ, TH1F* tW, TH1F* Wantitop, TH1F* dy, TH1F* DATA, THStack* DATA_MC, TString title, TString name, bool logx);
...
//double pt_bins[12] = {50.0, 200.0, 400.0, 600.0, 900.0, 1200.0, 1500.0, 1900.0, 2300.0, 2700.0, 3100.0, 3500.0};
//double pt_bins[7] = {50.0, 200.0, 500.0, 1000.0, 1500.0, 2500.0, 4000.0};
double pt_bins[7] = {50.0, 200.0, 500.0, 1250.0, 1750.0, 3000.0, 4000.0};
...
void FR(){
    ...
    ////////////////////qcd///////////////////////////////////
    TH1F* qcd_num_pt_Barrel = new TH1F("qcd_num_pt_Barrel", "qcd_num_pt_Barrel", binnum_pt, pt_bins);
    qcd_num_pt_Barrel->Sumw2();
    TH1F* qcd_den_pt_Barrel = new TH1F("qcd_den_pt_Barrel", "qcd_den_pt_Barrel", binnum_pt, pt_bins);
    qcd_den_pt_Barrel->Sumw2();
    TH1F* qcd_num_pt_Endcap = new TH1F("qcd_num_pt_Endcap", "qcd_num_pt_Endcap", binnum_pt, pt_bins);
    qcd_num_pt_Endcap->Sumw2();
    TH1F* qcd_den_pt_Endcap = new TH1F("qcd_den_pt_Endcap", "qcd_den_pt_Endcap", binnum_pt, pt_bins);
    qcd_den_pt_Endcap->Sumw2();
    
    TH1F* qcd_num_pt_Barrel_fx = new TH1F("qcd_num_pt_Barrel_fx", "qcd_num_pt_Barrel_fx", binnum_pt, pt_bins);
    qcd_num_pt_Barrel_fx->Sumw2();
    TH1F* qcd_den_pt_Barrel_fx = new TH1F("qcd_den_pt_Barrel_fx", "qcd_den_pt_Barrel_fx", binnum_pt, pt_bins);
    qcd_den_pt_Barrel_fx->Sumw2();
    TH1F* qcd_num_pt_Endcap_fx = new TH1F("qcd_num_pt_Endcap_fx", "qcd_num_pt_Endcap_fx", binnum_pt, pt_bins);
    qcd_num_pt_Endcap_fx->Sumw2();
    TH1F* qcd_den_pt_Endcap_fx = new TH1F("qcd_den_pt_Endcap_fx", "qcd_den_pt_Endcap_fx", binnum_pt, pt_bins);
    qcd_den_pt_Endcap_fx->Sumw2();
    
    TH1F* qcd_num_eta = new TH1F("qcd_num_eta", "qcd_num_eta", 50, -3, 3);
    TH1F* qcd_den_eta = new TH1F("qcd_den_eta", "qcd_den_eta", 50, -3, 3);
    TH1F* qcd_num_eta_Barrel = new TH1F("qcd_num_eta_Barrel", "qcd_num_eta_Barrel", 50, -3, 3);
    TH1F* qcd_den_eta_Barrel = new TH1F("qcd_den_eta_Barrel", "qcd_den_eta_Barrel", 50, -3, 3);
    TH1F* qcd_num_eta_Endcap = new TH1F("qcd_num_eta_Endcap", "qcd_num_eta_Endcap", 50, -3, 3);
    TH1F* qcd_den_eta_Endcap = new TH1F("qcd_den_eta_Endcap", "qcd_den_eta_Endcap", 50, -3, 3);
    
    TH1F* qcd_num_mass_log = new TH1F("qcd_num_mass_log", "qcd_num_mass_log", NMBINS, logMbins);
    TH1F* qcd_num_mass_log_BB = new TH1F("qcd_num_mass_log_BB", "qcd_num_mass_log_BB", NMBINS, logMbins);
    TH1F* qcd_num_mass_log_BE = new TH1F("qcd_num_mass_log_BE", "qcd_num_mass_log_BE", NMBINS, logMbins);
    
    TH1F* qcd_den_mass_log = new TH1F("qcd_den_mass_log", "qcd_den_mass_log", NMBINS, logMbins);
    TH1F* qcd_den_mass_log_BB = new TH1F("qcd_den_mass_log_BB", "qcd_den_mass_log_BB", NMBINS, logMbins);
    TH1F* qcd_den_mass_log_BE = new TH1F("qcd_den_mass_log_BE", "qcd_den_mass_log_BE", NMBINS, logMbins);
    
    TH1F* num_qcd_transverse_mass = new TH1F("num_qcd_transverse_mass", "num_qcd_transverse_mass", 50, 0, 500);
    num_qcd_transverse_mass->Sumw2();
    TH1F* num_qcd_dz = new TH1F("num_qcd_dz", "num_qcd_dz", 50, 0, 10);
    TH1F* num_qcd_met_pt = new TH1F("num_qcd_met_pt", "num_qcd_met_pt", 100, 0, 1000);
    num_qcd_met_pt->Sumw2();
    TH1F* num_qcd_met_phi = new TH1F("num_qcd_met_phi", "num_qcd_met_phi", 20, -3, 3);
    
    TH1F* den_qcd_transverse_mass = new TH1F("den_qcd_transverse_mass", "den_qcd_transverse_mass", 50, 0, 500);
    den_qcd_transverse_mass->Sumw2();
    TH1F* den_qcd_dz = new TH1F("den_qcd_dz", "den_qcd_dz", 50, 0, 10);
    TH1F* den_qcd_met_pt = new TH1F("den_qcd_met_pt", "den_qcd_met_pt", 100, 0, 1000);
    den_qcd_met_pt->Sumw2();
    TH1F* den_qcd_met_phi = new TH1F("den_qcd_met_phi", "den_qcd_met_phi", 20, -3, 3);
    
    
    /////////////////////////////////Wjets////////////////////////////////////////////
    TH1F* Wjets_num_pt_Barrel = new TH1F("Wjets_num_pt_Barrel", "Wjets_num_pt_Barrel", binnum_pt, pt_bins);
    Wjets_num_pt_Barrel->Sumw2();
    TH1F* Wjets_den_pt_Barrel = new TH1F("Wjets_den_pt_Barrel", "Wjets_den_pt_Barrel", binnum_pt, pt_bins);
    Wjets_den_pt_Barrel->Sumw2();
    TH1F* Wjets_num_pt_Endcap = new TH1F("Wjets_num_pt_Endcap", "Wjets_num_pt_Endcap", binnum_pt, pt_bins);
    Wjets_num_pt_Endcap->Sumw2();
    TH1F* Wjets_den_pt_Endcap = new TH1F("Wjets_den_pt_Endcap", "Wjets_den_pt_Endcap", binnum_pt, pt_bins);
    Wjets_den_pt_Endcap->Sumw2();
    
    TH1F* Wjets_num_pt_Barrel_fx = new TH1F("Wjets_num_pt_Barrel_fx", "Wjets_num_pt_Barrel_fx", binnum_pt, pt_bins);
    Wjets_num_pt_Barrel_fx->Sumw2();
    TH1F* Wjets_den_pt_Barrel_fx = new TH1F("Wjets_den_pt_Barrel_fx", "Wjets_den_pt_Barrel_fx", binnum_pt, pt_bins);
    Wjets_den_pt_Barrel_fx->Sumw2();
    TH1F* Wjets_num_pt_Endcap_fx = new TH1F("Wjets_num_pt_Endcap_fx", "Wjets_num_pt_Endcap_fx", binnum_pt, pt_bins);
    Wjets_num_pt_Endcap_fx->Sumw2();
    TH1F* Wjets_den_pt_Endcap_fx = new TH1F("Wjets_den_pt_Endcap_fx", "Wjets_den_pt_Endcap_fx", binnum_pt, pt_bins);
    Wjets_den_pt_Endcap_fx->Sumw2();
    
    TH1F* Wjets_num_eta = new TH1F("Wjets_num_eta", "Wjets_num_eta", 50, -3, 3);
    TH1F* Wjets_den_eta = new TH1F("Wjets_den_eta", "Wjets_den_eta", 50, -3, 3);
    TH1F* Wjets_num_eta_Barrel = new TH1F("Wjets_num_eta_Barrel", "Wjets_num_eta_Barrel", 50, -3, 3);
    TH1F* Wjets_den_eta_Barrel = new TH1F("Wjets_den_eta_Barrel", "Wjets_den_eta_Barrel", 50, -3, 3);
    TH1F* Wjets_num_eta_Endcap = new TH1F("Wjets_num_eta_Endcap", "Wjets_num_eta_Endcap", 50, -3, 3);
    TH1F* Wjets_den_eta_Endcap = new TH1F("Wjets_den_eta_Endcap", "Wjets_den_eta_Endcap", 50, -3, 3);
    
    TH1F* Wjets_num_mass_log = new TH1F("Wjets_num_mass_log", "Wjets_num_mass_log", NMBINS, logMbins);
    TH1F* Wjets_num_mass_log_BB = new TH1F("Wjets_num_mass_log_BB", "Wjets_num_mass_log_BB", NMBINS, logMbins);
    TH1F* Wjets_num_mass_log_BE = new TH1F("Wjets_num_mass_log_BE", "Wjets_num_mass_log_BE", NMBINS, logMbins);
    
    TH1F* Wjets_den_mass_log = new TH1F("Wjets_den_mass_log", "Wjets_den_mass_log", NMBINS, logMbins);
    TH1F* Wjets_den_mass_log_BB = new TH1F("Wjets_den_mass_log_BB", "Wjets_den_mass_log_BB", NMBINS, logMbins);
    TH1F* Wjets_den_mass_log_BE = new TH1F("Wjets_den_mass_log_BE", "Wjets_den_mass_log_BE", NMBINS, logMbins);
    
    
    TH1F* num_Wjets_transverse_mass = new TH1F("num_Wjets_transverse_mass", "num_Wjets_transverse_mass", 50, 0, 500);
    num_Wjets_transverse_mass->Sumw2();
    TH1F* num_Wjets_dz = new TH1F("num_Wjets_dz", "num_Wjets_dz", 50, 0, 10);
    TH1F* num_Wjets_met_pt = new TH1F("num_Wjets_met_pt", "num_Wjets_met_pt", 100, 0, 1000);
    num_Wjets_met_pt->Sumw2();
    TH1F* num_Wjets_met_phi = new TH1F("num_Wjets_met_phi", "num_Wjets_met_phi", 20, -3, 3);
    
    TH1F* den_Wjets_transverse_mass = new TH1F("den_Wjets_transverse_mass", "den_Wjets_transverse_mass", 50, 0, 500);
    den_Wjets_transverse_mass->Sumw2();
    TH1F* den_Wjets_dz = new TH1F("den_Wjets_dz", "den_Wjets_dz", 50, 0, 10);
    TH1F* den_Wjets_met_pt = new TH1F("den_Wjets_met_pt", "den_Wjets_met_pt", 100, 0, 1000);
    den_Wjets_met_pt->Sumw2();
    TH1F* den_Wjets_met_phi = new TH1F("den_Wjets_met_phi", "den_Wjets_met_phi", 20, -3, 3);
    
    
    /////////////////////////////////Zjets////////////////////////////////////////////
    TH1F* Zjets_num_pt_Barrel = new TH1F("Zjets_num_pt_Barrel", "Zjets_num_pt_Barrel", binnum_pt, pt_bins);
    Zjets_num_pt_Barrel->Sumw2();
    TH1F* Zjets_den_pt_Barrel = new TH1F("Zjets_den_pt_Barrel", "Zjets_den_pt_Barrel", binnum_pt, pt_bins);
    Zjets_den_pt_Barrel->Sumw2();
    TH1F* Zjets_num_pt_Endcap = new TH1F("Zjets_num_pt_Endcap", "Zjets_num_pt_Endcap", binnum_pt, pt_bins);
    Zjets_num_pt_Endcap->Sumw2();
    TH1F* Zjets_den_pt_Endcap = new TH1F("Zjets_den_pt_Endcap", "Zjets_den_pt_Endcap", binnum_pt, pt_bins);
    Zjets_den_pt_Endcap->Sumw2();
    
    TH1F* Zjets_num_pt_Barrel_fx = new TH1F("Zjets_num_pt_Barrel_fx", "Zjets_num_pt_Barrel_fx", binnum_pt, pt_bins);
    Zjets_num_pt_Barrel_fx->Sumw2();
    TH1F* Zjets_den_pt_Barrel_fx = new TH1F("Zjets_den_pt_Barrel_fx", "Zjets_den_pt_Barrel_fx", binnum_pt, pt_bins);
    Zjets_den_pt_Barrel_fx->Sumw2();
    TH1F* Zjets_num_pt_Endcap_fx = new TH1F("Zjets_num_pt_Endcap_fx", "Zjets_num_pt_Endcap_fx", binnum_pt, pt_bins);
    Zjets_num_pt_Endcap_fx->Sumw2();
    TH1F* Zjets_den_pt_Endcap_fx = new TH1F("Zjets_den_pt_Endcap_fx", "Zjets_den_pt_Endcap_fx", binnum_pt, pt_bins);
    Zjets_den_pt_Endcap_fx->Sumw2();
    
    TH1F* Zjets_num_eta = new TH1F("Zjets_num_eta", "Zjets_num_eta", 50, -3, 3);
    TH1F* Zjets_den_eta = new TH1F("Zjets_den_eta", "Zjets_den_eta", 50, -3, 3);
    TH1F* Zjets_num_eta_Barrel = new TH1F("Zjets_num_eta_Barrel", "Zjets_num_eta_Barrel", 50, -3, 3);
    TH1F* Zjets_den_eta_Barrel = new TH1F("Zjets_den_eta_Barrel", "Zjets_den_eta_Barrel", 50, -3, 3);
    TH1F* Zjets_num_eta_Endcap = new TH1F("Zjets_num_eta_Endcap", "Zjets_num_eta_Endcap", 50, -3, 3);
    TH1F* Zjets_den_eta_Endcap = new TH1F("Zjets_den_eta_Endcap", "Zjets_den_eta_Endcap", 50, -3, 3);
    
    TH1F* Zjets_num_mass_log = new TH1F("Zjets_num_mass_log", "Zjets_num_mass_log", NMBINS, logMbins);
    TH1F* Zjets_num_mass_log_BB = new TH1F("Zjets_num_mass_log_BB", "Zjets_num_mass_log_BB", NMBINS, logMbins);
    TH1F* Zjets_num_mass_log_BE = new TH1F("Zjets_num_mass_log_BE", "Zjets_num_mass_log_BE", NMBINS, logMbins);
    
    TH1F* Zjets_den_mass_log = new TH1F("Zjets_den_mass_log", "Zjets_den_mass_log", NMBINS, logMbins);
    TH1F* Zjets_den_mass_log_BB = new TH1F("Zjets_den_mass_log_BB", "Zjets_den_mass_log_BB", NMBINS, logMbins);
    TH1F* Zjets_den_mass_log_BE = new TH1F("Zjets_den_mass_log_BE", "Zjets_den_mass_log_BE", NMBINS, logMbins);
    
    TH1F* num_Zjets_transverse_mass = new TH1F("num_Zjets_transverse_mass", "num_Zjets_transverse_mass", 50, 0, 500);
    num_Zjets_transverse_mass->Sumw2();
    TH1F* num_Zjets_dz = new TH1F("num_Zjets_dz", "num_Zjets_dz", 50, 0, 10);
    TH1F* num_Zjets_met_pt = new TH1F("num_Zjets_met_pt", "num_Zjets_met_pt", 100, 0, 1000);
    num_Zjets_met_pt->Sumw2();
    TH1F* num_Zjets_met_phi = new TH1F("num_Zjets_met_phi", "num_Zjets_met_phi", 20, -3, 3);
    
    TH1F* den_Zjets_transverse_mass = new TH1F("den_Zjets_transverse_mass", "den_Zjets_transverse_mass", 50, 0, 500);
    den_Zjets_transverse_mass->Sumw2();
    TH1F* den_Zjets_dz = new TH1F("den_Zjets_dz", "den_Zjets_dz", 50, 0, 10);
    TH1F* den_Zjets_met_pt = new TH1F("den_Zjets_met_pt", "den_Zjets_met_pt", 100, 0, 1000);
    den_Zjets_met_pt->Sumw2();
    TH1F* den_Zjets_met_phi = new TH1F("den_Zjets_met_phi", "den_Zjets_met_phi", 20, -3, 3);
    
    ////////////////////////////////ttbar////////////////////////////////////////////
    TH1F* ttbar_num_pt_Barrel = new TH1F("ttbar_num_pt_Barrel", "ttbar_num_pt_Barrel", binnum_pt, pt_bins);
    ttbar_num_pt_Barrel->Sumw2();
    TH1F* ttbar_den_pt_Barrel = new TH1F("ttbar_den_pt_Barrel", "ttbar_den_pt_Barrel", binnum_pt, pt_bins);
    ttbar_den_pt_Barrel->Sumw2();
    TH1F* ttbar_num_pt_Endcap = new TH1F("ttbar_num_pt_Endcap", "ttbar_num_pt_Endcap", binnum_pt, pt_bins);
    ttbar_num_pt_Endcap->Sumw2();
    TH1F* ttbar_den_pt_Endcap = new TH1F("ttbar_den_pt_Endcap", "ttbar_den_pt_Endcap", binnum_pt, pt_bins);
    ttbar_den_pt_Endcap->Sumw2();
    
    TH1F* ttbar_num_pt_Barrel_fx = new TH1F("ttbar_num_pt_Barrel_fx", "ttbar_num_pt_Barrel_fx", binnum_pt, pt_bins);
    ttbar_num_pt_Barrel_fx->Sumw2();
    TH1F* ttbar_den_pt_Barrel_fx = new TH1F("ttbar_den_pt_Barrel_fx", "ttbar_den_pt_Barrel_fx", binnum_pt, pt_bins);
    ttbar_den_pt_Barrel_fx->Sumw2();
    TH1F* ttbar_num_pt_Endcap_fx = new TH1F("ttbar_num_pt_Endcap_fx", "ttbar_num_pt_Endcap_fx", binnum_pt, pt_bins);
    ttbar_num_pt_Endcap_fx->Sumw2();
    TH1F* ttbar_den_pt_Endcap_fx = new TH1F("ttbar_den_pt_Endcap_fx", "ttbar_den_pt_Endcap_fx", binnum_pt, pt_bins);
    ttbar_den_pt_Endcap_fx->Sumw2();
    
    TH1F* ttbar_num_eta = new TH1F("ttbar_num_eta", "ttbar_num_eta", 50, -3, 3);
    TH1F* ttbar_den_eta = new TH1F("ttbar_den_eta", "ttbar_den_eta", 50, -3, 3);
    TH1F* ttbar_num_eta_Barrel = new TH1F("ttbar_num_eta_Barrel", "ttbar_num_eta_Barrel", 50, -3, 3);
    TH1F* ttbar_den_eta_Barrel = new TH1F("ttbar_den_eta_Barrel", "ttbar_den_eta_Barrel", 50, -3, 3);
    TH1F* ttbar_num_eta_Endcap = new TH1F("ttbar_num_eta_Endcap", "ttbar_num_eta_Endcap", 50, -3, 3);
    TH1F* ttbar_den_eta_Endcap = new TH1F("ttbar_den_eta_Endcap", "ttbar_den_eta_Endcap", 50, -3, 3);
    
    TH1F* ttbar_num_mass_log = new TH1F("ttbar_num_mass_log", "ttbar_num_mass_log", NMBINS, logMbins);
    TH1F* ttbar_num_mass_log_BB = new TH1F("ttbar_num_mass_log_BB", "ttbar_num_mass_log_BB", NMBINS, logMbins);
    TH1F* ttbar_num_mass_log_BE = new TH1F("ttbar_num_mass_log_BE", "ttbar_num_mass_log_BE", NMBINS, logMbins);
    
    TH1F* ttbar_den_mass_log = new TH1F("ttbar_den_mass_log", "ttbar_den_mass_log", NMBINS, logMbins);
    TH1F* ttbar_den_mass_log_BB = new TH1F("ttbar_den_mass_log_BB", "ttbar_den_mass_log_BB", NMBINS, logMbins);
    TH1F* ttbar_den_mass_log_BE = new TH1F("ttbar_den_mass_log_BE", "ttbar_den_mass_log_BE", NMBINS, logMbins);
    
    TH1F* num_ttbar_transverse_mass = new TH1F("num_ttbar_transverse_mass", "num_ttbar_transverse_mass", 50, 0, 500);
    num_ttbar_transverse_mass->Sumw2();
    TH1F* num_ttbar_dz = new TH1F("num_ttbar_dz", "num_ttbar_dz", 50, 0, 10);
    TH1F* num_ttbar_met_pt = new TH1F("num_ttbar_met_pt", "num_ttbar_met_pt", 100, 0, 1000);
    num_ttbar_met_pt->Sumw2();
    TH1F* num_ttbar_met_phi = new TH1F("num_ttbar_met_phi", "num_ttbar_met_phi", 20, -3, 3);
    
    TH1F* den_ttbar_transverse_mass = new TH1F("den_ttbar_transverse_mass", "den_ttbar_transverse_mass", 50, 0, 500);
    den_ttbar_transverse_mass->Sumw2();
    TH1F* den_ttbar_dz = new TH1F("den_ttbar_dz", "den_ttbar_dz", 50, 0, 10);
    TH1F* den_ttbar_met_pt = new TH1F("den_ttbar_met_pt", "den_ttbar_met_pt", 100, 0, 1000);
    den_ttbar_met_pt->Sumw2();
    TH1F* den_ttbar_met_phi = new TH1F("den_ttbar_met_phi", "den_ttbar_met_phi", 20, -3, 3);
    
    
    /////////////////////////////////WW////////////////////////////////////////////
    TH1F* WW_num_pt_Barrel = new TH1F("WW_num_pt_Barrel", "WW_num_pt_Barrel", binnum_pt, pt_bins);
    WW_num_pt_Barrel->Sumw2();
    TH1F* WW_den_pt_Barrel = new TH1F("WW_den_pt_Barrel", "WW_den_pt_Barrel", binnum_pt, pt_bins);
    WW_den_pt_Barrel->Sumw2();
    TH1F* WW_num_pt_Endcap = new TH1F("WW_num_pt_Endcap", "WW_num_pt_Endcap", binnum_pt, pt_bins);
    WW_num_pt_Endcap->Sumw2();
    TH1F* WW_den_pt_Endcap = new TH1F("WW_den_pt_Endcap", "WW_den_pt_Endcap", binnum_pt, pt_bins);
    WW_den_pt_Endcap->Sumw2();
    
    TH1F* WW_num_pt_Barrel_fx = new TH1F("WW_num_pt_Barrel_fx", "WW_num_pt_Barrel_fx", binnum_pt, pt_bins);
    WW_num_pt_Barrel_fx->Sumw2();
    TH1F* WW_den_pt_Barrel_fx = new TH1F("WW_den_pt_Barrel_fx", "WW_den_pt_Barrel_fx", binnum_pt, pt_bins);
    WW_den_pt_Barrel_fx->Sumw2();
    TH1F* WW_num_pt_Endcap_fx = new TH1F("WW_num_pt_Endcap_fx", "WW_num_pt_Endcap_fx", binnum_pt, pt_bins);
    WW_num_pt_Endcap_fx->Sumw2();
    TH1F* WW_den_pt_Endcap_fx = new TH1F("WW_den_pt_Endcap_fx", "WW_den_pt_Endcap_fx", binnum_pt, pt_bins);
    WW_den_pt_Endcap_fx->Sumw2();
    
    TH1F* WW_num_eta = new TH1F("WW_num_eta", "WW_num_eta", 50, -3, 3);
    TH1F* WW_den_eta = new TH1F("WW_den_eta", "WW_den_eta", 50, -3, 3);
    TH1F* WW_num_eta_Barrel = new TH1F("WW_num_eta_Barrel", "WW_num_eta_Barrel", 50, -3, 3);
    TH1F* WW_den_eta_Barrel = new TH1F("WW_den_eta_Barrel", "WW_den_eta_Barrel", 50, -3, 3);
    TH1F* WW_num_eta_Endcap = new TH1F("WW_num_eta_Endcap", "WW_num_eta_Endcap", 50, -3, 3);
    TH1F* WW_den_eta_Endcap = new TH1F("WW_den_eta_Endcap", "WW_den_eta_Endcap", 50, -3, 3);
    
    TH1F* WW_num_mass_log = new TH1F("WW_num_mass_log", "WW_num_mass_log", NMBINS, logMbins);
    TH1F* WW_num_mass_log_BB = new TH1F("WW_num_mass_log_BB", "WW_num_mass_log_BB", NMBINS, logMbins);
    TH1F* WW_num_mass_log_BE = new TH1F("WW_num_mass_log_BE", "WW_num_mass_log_BE", NMBINS, logMbins);
    
    TH1F* WW_den_mass_log = new TH1F("WW_den_mass_log", "WW_den_mass_log", NMBINS, logMbins);
    TH1F* WW_den_mass_log_BB = new TH1F("WW_den_mass_log_BB", "WW_den_mass_log_BB", NMBINS, logMbins);
    TH1F* WW_den_mass_log_BE = new TH1F("WW_den_mass_log_BE", "WW_den_mass_log_BE", NMBINS, logMbins);
    
    TH1F* num_WW_transverse_mass = new TH1F("num_WW_transverse_mass", "num_WW_transverse_mass", 50, 0, 500);
    num_WW_transverse_mass->Sumw2();
    TH1F* num_WW_dz = new TH1F("num_WW_dz", "num_WW_dz", 50, 0, 10);
    TH1F* num_WW_met_pt = new TH1F("num_WW_met_pt", "num_WW_met_pt", 100, 0, 1000);
    num_WW_met_pt->Sumw2();
    TH1F* num_WW_met_phi = new TH1F("num_WW_met_phi", "num_WW_met_phi", 20, -3, 3);
    
    TH1F* den_WW_transverse_mass = new TH1F("den_WW_transverse_mass", "den_WW_transverse_mass", 50, 0, 500);
    den_WW_transverse_mass->Sumw2();
    TH1F* den_WW_dz = new TH1F("den_WW_dz", "den_WW_dz", 50, 0, 10);
    TH1F* den_WW_met_pt = new TH1F("den_WW_met_pt", "den_WW_met_pt", 100, 0, 1000);
    den_WW_met_pt->Sumw2();
    TH1F* den_WW_met_phi = new TH1F("den_WW_met_phi", "den_WW_met_phi", 20, -3, 3);
    
    
    /////////////////////////////////WZ////////////////////////////////////////////
    TH1F* WZ_num_pt_Barrel = new TH1F("WZ_num_pt_Barrel", "WZ_num_pt_Barrel", binnum_pt, pt_bins);
    WZ_num_pt_Barrel->Sumw2();
    TH1F* WZ_den_pt_Barrel = new TH1F("WZ_den_pt_Barrel", "WZ_den_pt_Barrel", binnum_pt, pt_bins);
    WZ_den_pt_Barrel->Sumw2();
    TH1F* WZ_num_pt_Endcap = new TH1F("WZ_num_pt_Endcap", "WZ_num_pt_Endcap", binnum_pt, pt_bins);
    WZ_num_pt_Endcap->Sumw2();
    TH1F* WZ_den_pt_Endcap = new TH1F("WZ_den_pt_Endcap", "WZ_den_pt_Endcap", binnum_pt, pt_bins);
    WZ_den_pt_Endcap->Sumw2();
    
    TH1F* WZ_num_pt_Barrel_fx = new TH1F("WZ_num_pt_Barrel_fx", "WZ_num_pt_Barrel_fx", binnum_pt, pt_bins);
    WZ_num_pt_Barrel_fx->Sumw2();
    TH1F* WZ_den_pt_Barrel_fx = new TH1F("WZ_den_pt_Barrel_fx", "WZ_den_pt_Barrel_fx", binnum_pt, pt_bins);
    WZ_den_pt_Barrel_fx->Sumw2();
    TH1F* WZ_num_pt_Endcap_fx = new TH1F("WZ_num_pt_Endcap_fx", "WZ_num_pt_Endcap_fx", binnum_pt, pt_bins);
    WZ_num_pt_Endcap_fx->Sumw2();
    TH1F* WZ_den_pt_Endcap_fx = new TH1F("WZ_den_pt_Endcap_fx", "WZ_den_pt_Endcap_fx", binnum_pt, pt_bins);
    WZ_den_pt_Endcap_fx->Sumw2();
    
    TH1F* WZ_num_eta = new TH1F("WZ_num_eta", "WZ_num_eta", 50, -3, 3);
    TH1F* WZ_den_eta = new TH1F("WZ_den_eta", "WZ_den_eta", 50, -3, 3);
    TH1F* WZ_num_eta_Barrel = new TH1F("WZ_num_eta_Barrel", "WZ_num_eta_Barrel", 50, -3, 3);
    TH1F* WZ_den_eta_Barrel = new TH1F("WZ_den_eta_Barrel", "WZ_den_eta_Barrel", 50, -3, 3);
    TH1F* WZ_num_eta_Endcap = new TH1F("WZ_num_eta_Endcap", "WZ_num_eta_Endcap", 50, -3, 3);
    TH1F* WZ_den_eta_Endcap = new TH1F("WZ_den_eta_Endcap", "WZ_den_eta_Endcap", 50, -3, 3);
    
    TH1F* WZ_num_mass_log = new TH1F("WZ_num_mass_log", "WZ_num_mass_log", NMBINS, logMbins);
    TH1F* WZ_num_mass_log_BB = new TH1F("WZ_num_mass_log_BB", "WZ_num_mass_log_BB", NMBINS, logMbins);
    TH1F* WZ_num_mass_log_BE = new TH1F("WZ_num_mass_log_BE", "WZ_num_mass_log_BE", NMBINS, logMbins);
    
    TH1F* WZ_den_mass_log = new TH1F("WZ_den_mass_log", "WZ_den_mass_log", NMBINS, logMbins);
    TH1F* WZ_den_mass_log_BB = new TH1F("WZ_den_mass_log_BB", "WZ_den_mass_log_BB", NMBINS, logMbins);
    TH1F* WZ_den_mass_log_BE = new TH1F("WZ_den_mass_log_BE", "WZ_den_mass_log_BE", NMBINS, logMbins);
    
    TH1F* num_WZ_transverse_mass = new TH1F("num_WZ_transverse_mass", "num_WZ_transverse_mass", 50, 0, 500);
    num_WZ_transverse_mass->Sumw2();
    TH1F* num_WZ_dz = new TH1F("num_WZ_dz", "num_WZ_dz", 50, 0, 10);
    TH1F* num_WZ_met_pt = new TH1F("num_WZ_met_pt", "num_WZ_met_pt", 100, 0, 1000);
    num_WZ_met_pt->Sumw2();
    TH1F* num_WZ_met_phi = new TH1F("num_WZ_met_phi", "num_WZ_met_phi", 20, -3, 3);
    
    TH1F* den_WZ_transverse_mass = new TH1F("den_WZ_transverse_mass", "den_WZ_transverse_mass", 50, 0, 500);
    den_WZ_transverse_mass->Sumw2();
    TH1F* den_WZ_dz = new TH1F("den_WZ_dz", "den_WZ_dz", 50, 0, 10);
    TH1F* den_WZ_met_pt = new TH1F("den_WZ_met_pt", "den_WZ_met_pt", 100, 0, 1000);
    den_WZ_met_pt->Sumw2();
    TH1F* den_WZ_met_phi = new TH1F("den_WZ_met_phi", "den_WZ_met_phi", 20, -3, 3);
    
    /////////////////////////////////ZZ////////////////////////////////////////////
    TH1F* ZZ_num_pt_Barrel = new TH1F("ZZ_num_pt_Barrel", "ZZ_num_pt_Barrel", binnum_pt, pt_bins);
    ZZ_num_pt_Barrel->Sumw2();
    TH1F* ZZ_den_pt_Barrel = new TH1F("ZZ_den_pt_Barrel", "ZZ_den_pt_Barrel", binnum_pt, pt_bins);
    ZZ_den_pt_Barrel->Sumw2();
    TH1F* ZZ_num_pt_Endcap = new TH1F("ZZ_num_pt_Endcap", "ZZ_num_pt_Endcap", binnum_pt, pt_bins);
    ZZ_num_pt_Endcap->Sumw2();
    TH1F* ZZ_den_pt_Endcap = new TH1F("ZZ_den_pt_Endcap", "ZZ_den_pt_Endcap", binnum_pt, pt_bins);
    ZZ_den_pt_Endcap->Sumw2();
    
    TH1F* ZZ_num_pt_Barrel_fx = new TH1F("ZZ_num_pt_Barrel_fx", "ZZ_num_pt_Barrel_fx", binnum_pt, pt_bins);
    ZZ_num_pt_Barrel_fx->Sumw2();
    TH1F* ZZ_den_pt_Barrel_fx = new TH1F("ZZ_den_pt_Barrel_fx", "ZZ_den_pt_Barrel_fx", binnum_pt, pt_bins);
    ZZ_den_pt_Barrel_fx->Sumw2();
    TH1F* ZZ_num_pt_Endcap_fx = new TH1F("ZZ_num_pt_Endcap_fx", "ZZ_num_pt_Endcap_fx", binnum_pt, pt_bins);
    ZZ_num_pt_Endcap_fx->Sumw2();
    TH1F* ZZ_den_pt_Endcap_fx = new TH1F("ZZ_den_pt_Endcap_fx", "ZZ_den_pt_Endcap_fx", binnum_pt, pt_bins);
    ZZ_den_pt_Endcap_fx->Sumw2();
    
    TH1F* ZZ_num_eta = new TH1F("ZZ_num_eta", "ZZ_num_eta", 50, -3, 3);
    TH1F* ZZ_den_eta = new TH1F("ZZ_den_eta", "ZZ_den_eta", 50, -3, 3);
    TH1F* ZZ_num_eta_Barrel = new TH1F("ZZ_num_eta_Barrel", "ZZ_num_eta_Barrel", 50, -3, 3);
    TH1F* ZZ_den_eta_Barrel = new TH1F("ZZ_den_eta_Barrel", "ZZ_den_eta_Barrel", 50, -3, 3);
    TH1F* ZZ_num_eta_Endcap = new TH1F("ZZ_num_eta_Endcap", "ZZ_num_eta_Endcap", 50, -3, 3);
    TH1F* ZZ_den_eta_Endcap = new TH1F("ZZ_den_eta_Endcap", "ZZ_den_eta_Endcap", 50, -3, 3);
    
    TH1F* ZZ_num_mass_log = new TH1F("ZZ_num_mass_log", "ZZ_num_mass_log", NMBINS, logMbins);
    TH1F* ZZ_num_mass_log_BB = new TH1F("ZZ_num_mass_log_BB", "ZZ_num_mass_log_BB", NMBINS, logMbins);
    TH1F* ZZ_num_mass_log_BE = new TH1F("ZZ_num_mass_log_BE", "ZZ_num_mass_log_BE", NMBINS, logMbins);
    
    TH1F* ZZ_den_mass_log = new TH1F("ZZ_den_mass_log", "ZZ_den_mass_log", NMBINS, logMbins);
    TH1F* ZZ_den_mass_log_BB = new TH1F("ZZ_den_mass_log_BB", "ZZ_den_mass_log_BB", NMBINS, logMbins);
    TH1F* ZZ_den_mass_log_BE = new TH1F("ZZ_den_mass_log_BE", "ZZ_den_mass_log_BE", NMBINS, logMbins);
    
    TH1F* num_ZZ_transverse_mass = new TH1F("num_ZZ_transverse_mass", "num_ZZ_transverse_mass", 50, 0, 500);
    num_ZZ_transverse_mass->Sumw2();
    TH1F* num_ZZ_dz = new TH1F("num_ZZ_dz", "num_ZZ_dz", 50, 0, 10);
    TH1F* num_ZZ_met_pt = new TH1F("num_ZZ_met_pt", "num_ZZ_met_pt", 100, 0, 1000);
    num_ZZ_met_pt->Sumw2();
    TH1F* num_ZZ_met_phi = new TH1F("num_ZZ_met_phi", "num_ZZ_met_phi", 20, -3, 3);
    
    TH1F* den_ZZ_transverse_mass = new TH1F("den_ZZ_transverse_mass", "den_ZZ_transverse_mass", 50, 0, 500);
    den_ZZ_transverse_mass->Sumw2();
    TH1F* den_ZZ_dz = new TH1F("den_ZZ_dz", "den_ZZ_dz", 50, 0, 10);
    TH1F* den_ZZ_met_pt = new TH1F("den_ZZ_met_pt", "den_ZZ_met_pt", 100, 0, 1000);
    den_ZZ_met_pt->Sumw2();
    TH1F* den_ZZ_met_phi = new TH1F("den_ZZ_met_phi", "den_ZZ_met_phi", 20, -3, 3);
    
    /////////////////////////////////tW////////////////////////////////////////////
    TH1F* tW_num_pt_Barrel = new TH1F("tW_num_pt_Barrel", "tW_num_pt_Barrel", binnum_pt, pt_bins);
    tW_num_pt_Barrel->Sumw2();
    TH1F* tW_den_pt_Barrel = new TH1F("tW_den_pt_Barrel", "tW_den_pt_Barrel", binnum_pt, pt_bins);
    tW_den_pt_Barrel->Sumw2();
    TH1F* tW_num_pt_Endcap = new TH1F("tW_num_pt_Endcap", "tW_num_pt_Endcap", binnum_pt, pt_bins);
    tW_num_pt_Endcap->Sumw2();
    TH1F* tW_den_pt_Endcap = new TH1F("tW_den_pt_Endcap", "tW_den_pt_Endcap", binnum_pt, pt_bins);
    tW_den_pt_Endcap->Sumw2();
    
    TH1F* tW_num_pt_Barrel_fx = new TH1F("tW_num_pt_Barrel_fx", "tW_num_pt_Barrel_fx", binnum_pt, pt_bins);
    tW_num_pt_Barrel_fx->Sumw2();
    TH1F* tW_den_pt_Barrel_fx = new TH1F("tW_den_pt_Barrel_fx", "tW_den_pt_Barrel_fx", binnum_pt, pt_bins);
    tW_den_pt_Barrel_fx->Sumw2();
    TH1F* tW_num_pt_Endcap_fx = new TH1F("tW_num_pt_Endcap_fx", "tW_num_pt_Endcap_fx", binnum_pt, pt_bins);
    tW_num_pt_Endcap_fx->Sumw2();
    TH1F* tW_den_pt_Endcap_fx = new TH1F("tW_den_pt_Endcap_fx", "tW_den_pt_Endcap_fx", binnum_pt, pt_bins);
    tW_den_pt_Endcap_fx->Sumw2();
    
    TH1F* tW_num_eta = new TH1F("tW_num_eta", "tW_num_eta", 50, -3, 3);
    TH1F* tW_den_eta = new TH1F("tW_den_eta", "tW_den_eta", 50, -3, 3);
    TH1F* tW_num_eta_Barrel = new TH1F("tW_num_eta_Barrel", "tW_num_eta_Barrel", 50, -3, 3);
    TH1F* tW_den_eta_Barrel = new TH1F("tW_den_eta_Barrel", "tW_den_eta_Barrel", 50, -3, 3);
    TH1F* tW_num_eta_Endcap = new TH1F("tW_num_eta_Endcap", "tW_num_eta_Endcap", 50, -3, 3);
    TH1F* tW_den_eta_Endcap = new TH1F("tW_den_eta_Endcap", "tW_den_eta_Endcap", 50, -3, 3);
    
    TH1F* tW_num_mass_log = new TH1F("tW_num_mass_log", "tW_num_mass_log", NMBINS, logMbins);
    TH1F* tW_num_mass_log_BB = new TH1F("tW_num_mass_log_BB", "tW_num_mass_log_BB", NMBINS, logMbins);
    TH1F* tW_num_mass_log_BE = new TH1F("tW_num_mass_log_BE", "tW_num_mass_log_BE", NMBINS, logMbins);
    
    TH1F* tW_den_mass_log = new TH1F("tW_den_mass_log", "tW_den_mass_log", NMBINS, logMbins);
    TH1F* tW_den_mass_log_BB = new TH1F("tW_den_mass_log_BB", "tW_den_mass_log_BB", NMBINS, logMbins);
    TH1F* tW_den_mass_log_BE = new TH1F("tW_den_mass_log_BE", "tW_den_mass_log_BE", NMBINS, logMbins);
    
    TH1F* num_tW_transverse_mass = new TH1F("num_tW_transverse_mass", "num_tW_transverse_mass", 50, 0, 500);
    num_tW_transverse_mass->Sumw2();
    TH1F* num_tW_dz = new TH1F("num_tW_dz", "num_tW_dz", 50, 0, 10);
    TH1F* num_tW_met_pt = new TH1F("num_tW_met_pt", "num_tW_met_pt", 100, 0, 1000);
    num_tW_met_pt->Sumw2();
    TH1F* num_tW_met_phi = new TH1F("num_tW_met_phi", "num_tW_met_phi", 20, -3, 3);
    
    TH1F* den_tW_transverse_mass = new TH1F("den_tW_transverse_mass", "den_tW_transverse_mass", 50, 0, 500);
    den_tW_transverse_mass->Sumw2();
    TH1F* den_tW_dz = new TH1F("den_tW_dz", "den_tW_dz", 50, 0, 10);
    TH1F* den_tW_met_pt = new TH1F("den_tW_met_pt", "den_tW_met_pt", 100, 0, 1000);
    den_tW_met_pt->Sumw2();
    TH1F* den_tW_met_phi = new TH1F("den_tW_met_phi", "den_tW_met_phi", 20, -3, 3);
    
    
    /////////////////////////////////Wantitop////////////////////////////////////////////
    TH1F* Wantitop_num_pt_Barrel = new TH1F("Wantitop_num_pt_Barrel", "Wantitop_num_pt_Barrel", binnum_pt, pt_bins);
    Wantitop_num_pt_Barrel->Sumw2();
    TH1F* Wantitop_den_pt_Barrel = new TH1F("Wantitop_den_pt_Barrel", "Wantitop_den_pt_Barrel", binnum_pt, pt_bins);
    Wantitop_den_pt_Barrel->Sumw2();
    TH1F* Wantitop_num_pt_Endcap = new TH1F("Wantitop_num_pt_Endcap", "Wantitop_num_pt_Endcap", binnum_pt, pt_bins);
    Wantitop_num_pt_Endcap->Sumw2();
    TH1F* Wantitop_den_pt_Endcap = new TH1F("Wantitop_den_pt_Endcap", "Wantitop_den_pt_Endcap", binnum_pt, pt_bins);
    Wantitop_den_pt_Endcap->Sumw2();
    
    TH1F* Wantitop_num_pt_Barrel_fx = new TH1F("Wantitop_num_pt_Barrel_fx", "Wantitop_num_pt_Barrel_fx", binnum_pt, pt_bins);
    Wantitop_num_pt_Barrel_fx->Sumw2();
    TH1F* Wantitop_den_pt_Barrel_fx = new TH1F("Wantitop_den_pt_Barrel_fx", "Wantitop_den_pt_Barrel_fx", binnum_pt, pt_bins);
    Wantitop_den_pt_Barrel_fx->Sumw2();
    TH1F* Wantitop_num_pt_Endcap_fx = new TH1F("Wantitop_num_pt_Endcap_fx", "Wantitop_num_pt_Endcap_fx", binnum_pt, pt_bins);
    Wantitop_num_pt_Endcap_fx->Sumw2();
    TH1F* Wantitop_den_pt_Endcap_fx = new TH1F("Wantitop_den_pt_Endcap_fx", "Wantitop_den_pt_Endcap_fx", binnum_pt, pt_bins);
    Wantitop_den_pt_Endcap_fx->Sumw2();
    
    TH1F* Wantitop_num_eta = new TH1F("Wantitop_num_eta", "Wantitop_num_eta", 50, -3, 3);
    TH1F* Wantitop_den_eta = new TH1F("Wantitop_den_eta", "Wantitop_den_eta", 50, -3, 3);
    TH1F* Wantitop_num_eta_Barrel = new TH1F("Wantitop_num_eta_Barrel", "Wantitop_num_eta_Barrel", 50, -3, 3);
    TH1F* Wantitop_den_eta_Barrel = new TH1F("Wantitop_den_eta_Barrel", "Wantitop_den_eta_Barrel", 50, -3, 3);
    TH1F* Wantitop_num_eta_Endcap = new TH1F("Wantitop_num_eta_Endcap", "Wantitop_num_eta_Endcap", 50, -3, 3);
    TH1F* Wantitop_den_eta_Endcap = new TH1F("Wantitop_den_eta_Endcap", "Wantitop_den_eta_Endcap", 50, -3, 3);
    
    TH1F* Wantitop_num_mass_log = new TH1F("Wantitop_num_mass_log", "Wantitop_num_mass_log", NMBINS, logMbins);
    TH1F* Wantitop_num_mass_log_BB = new TH1F("Wantitop_num_mass_log_BB", "Wantitop_num_mass_log_BB", NMBINS, logMbins);
    TH1F* Wantitop_num_mass_log_BE = new TH1F("Wantitop_num_mass_log_BE", "Wantitop_num_mass_log_BE", NMBINS, logMbins);
    
    TH1F* Wantitop_den_mass_log = new TH1F("Wantitop_den_mass_log", "Wantitop_den_mass_log", NMBINS, logMbins);
    TH1F* Wantitop_den_mass_log_BB = new TH1F("Wantitop_den_mass_log_BB", "Wantitop_den_mass_log_BB", NMBINS, logMbins);
    TH1F* Wantitop_den_mass_log_BE = new TH1F("Wantitop_den_mass_log_BE", "Wantitop_den_mass_log_BE", NMBINS, logMbins);
    
    TH1F* num_Wantitop_transverse_mass = new TH1F("num_Wantitop_transverse_mass", "num_Wantitop_transverse_mass", 50, 0, 500);
    num_Wantitop_transverse_mass->Sumw2();
    TH1F* num_Wantitop_dz = new TH1F("num_Wantitop_dz", "num_Wantitop_dz", 50, 0, 10);
    TH1F* num_Wantitop_met_pt = new TH1F("num_Wantitop_met_pt", "num_Wantitop_met_pt", 100, 0, 1000);
    num_Wantitop_met_pt->Sumw2();
    TH1F* num_Wantitop_met_phi = new TH1F("num_Wantitop_met_phi", "num_Wantitop_met_phi", 20, -3, 3);
    
    TH1F* den_Wantitop_transverse_mass = new TH1F("den_Wantitop_transverse_mass", "den_Wantitop_transverse_mass", 50, 0, 500);
    den_Wantitop_transverse_mass->Sumw2();
    TH1F* den_Wantitop_dz = new TH1F("den_Wantitop_dz", "den_Wantitop_dz", 50, 0, 10);
    TH1F* den_Wantitop_met_pt = new TH1F("den_Wantitop_met_pt", "den_Wantitop_met_pt", 100, 0, 1000);
    den_Wantitop_met_pt->Sumw2();
    TH1F* den_Wantitop_met_phi = new TH1F("den_Wantitop_met_phi", "den_Wantitop_met_phi", 20, -3, 3);
    
    
    /////////////////////////////////dy////////////////////////////////////////////
    TH1F* dy_num_pt_Barrel = new TH1F("dy_num_pt_Barrel", "dy_num_pt_Barrel", binnum_pt, pt_bins);
    dy_num_pt_Barrel->Sumw2();
    TH1F* dy_den_pt_Barrel = new TH1F("dy_den_pt_Barrel", "dy_den_pt_Barrel", binnum_pt, pt_bins);
    dy_den_pt_Barrel->Sumw2();
    TH1F* dy_num_pt_Endcap = new TH1F("dy_num_pt_Endcap", "dy_num_pt_Endcap", binnum_pt, pt_bins);
    dy_num_pt_Endcap->Sumw2();
    TH1F* dy_den_pt_Endcap = new TH1F("dy_den_pt_Endcap", "dy_den_pt_Endcap", binnum_pt, pt_bins);
    dy_den_pt_Endcap->Sumw2();
    
    TH1F* dy_num_pt_Barrel_fx = new TH1F("dy_num_pt_Barrel_fx", "dy_num_pt_Barrel_fx", binnum_pt, pt_bins);
    dy_num_pt_Barrel_fx->Sumw2();
    TH1F* dy_den_pt_Barrel_fx = new TH1F("dy_den_pt_Barrel_fx", "dy_den_pt_Barrel_fx", binnum_pt, pt_bins);
    dy_den_pt_Barrel_fx->Sumw2();
    TH1F* dy_num_pt_Endcap_fx = new TH1F("dy_num_pt_Endcap_fx", "dy_num_pt_Endcap_fx", binnum_pt, pt_bins);
    dy_num_pt_Endcap_fx->Sumw2();
    TH1F* dy_den_pt_Endcap_fx = new TH1F("dy_den_pt_Endcap_fx", "dy_den_pt_Endcap_fx", binnum_pt, pt_bins);
    dy_den_pt_Endcap_fx->Sumw2();
    
    TH1F* dy_num_eta = new TH1F("dy_num_eta", "dy_num_eta", 50, -3, 3);
    TH1F* dy_den_eta = new TH1F("dy_den_eta", "dy_den_eta", 50, -3, 3);
    TH1F* dy_num_eta_Barrel = new TH1F("dy_num_eta_Barrel", "dy_num_eta_Barrel", 50, -3, 3);
    TH1F* dy_den_eta_Barrel = new TH1F("dy_den_eta_Barrel", "dy_den_eta_Barrel", 50, -3, 3);
    TH1F* dy_num_eta_Endcap = new TH1F("dy_num_eta_Endcap", "dy_num_eta_Endcap", 50, -3, 3);
    TH1F* dy_den_eta_Endcap = new TH1F("dy_den_eta_Endcap", "dy_den_eta_Endcap", 50, -3, 3);
    
    TH1F* dy_num_mass_log = new TH1F("dy_num_mass_log", "dy_num_mass_log", NMBINS, logMbins);
    TH1F* dy_num_mass_log_BB = new TH1F("dy_num_mass_log_BB", "dy_num_mass_log_BB", NMBINS, logMbins);
    TH1F* dy_num_mass_log_BE = new TH1F("dy_num_mass_log_BE", "dy_num_mass_log_BE", NMBINS, logMbins);
    
    TH1F* dy_den_mass_log = new TH1F("dy_den_mass_log", "dy_den_mass_log", NMBINS, logMbins);
    TH1F* dy_den_mass_log_BB = new TH1F("dy_den_mass_log_BB", "dy_den_mass_log_BB", NMBINS, logMbins);
    TH1F* dy_den_mass_log_BE = new TH1F("dy_den_mass_log_BE", "dy_den_mass_log_BE", NMBINS, logMbins);
    
    TH1F* num_dy_transverse_mass = new TH1F("num_dy_transverse_mass", "num_dy_transverse_mass", 50, 0, 500);
    num_dy_transverse_mass->Sumw2();
    TH1F* num_dy_dz = new TH1F("num_dy_dz", "num_dy_dz", 50, 0, 10);
    TH1F* num_dy_met_pt = new TH1F("num_dy_met_pt", "num_dy_met_pt", 100, 0, 1000);
    num_dy_met_pt->Sumw2();
    TH1F* num_dy_met_phi = new TH1F("num_dy_met_phi", "num_dy_met_phi", 20, -3, 3);
    
    TH1F* den_dy_transverse_mass = new TH1F("den_dy_transverse_mass", "den_dy_transverse_mass", 50, 0, 500);
    den_dy_transverse_mass->Sumw2();
    TH1F* den_dy_dz = new TH1F("den_dy_dz", "den_dy_dz", 50, 0, 10);
    TH1F* den_dy_met_pt = new TH1F("den_dy_met_pt", "den_dy_met_pt", 100, 0, 1000);
    den_dy_met_pt->Sumw2();
    TH1F* den_dy_met_phi = new TH1F("den_dy_met_phi", "den_dy_met_phi", 20, -3, 3);
    
    /////////////////////////////////Data////////////////////////////////////////////
    TH1F* Data_num_pt_Barrel = new TH1F("Data_num_pt_Barrel", "Data_num_pt_Barrel", binnum_pt, pt_bins);
    Data_num_pt_Barrel->Sumw2();
    TH1F* Data_den_pt_Barrel = new TH1F("Data_den_pt_Barrel", "Data_den_pt_Barrel", binnum_pt, pt_bins);
    Data_den_pt_Barrel->Sumw2();
    TH1F* Data_num_pt_Endcap = new TH1F("Data_num_pt_Endcap", "Data_num_pt_Endcap", binnum_pt, pt_bins);
    Data_num_pt_Endcap->Sumw2();
    TH1F* Data_den_pt_Endcap = new TH1F("Data_den_pt_Endcap", "Data_den_pt_Endcap", binnum_pt, pt_bins);
    Data_den_pt_Endcap->Sumw2();
    
    TH1F* Data_num_pt_Barrel_fx = new TH1F("Data_num_pt_Barrel_fx", "Data_num_pt_Barrel_fx", binnum_pt, pt_bins);
    Data_num_pt_Barrel_fx->Sumw2();
    TH1F* Data_den_pt_Barrel_fx = new TH1F("Data_den_pt_Barrel_fx", "Data_den_pt_Barrel_fx", binnum_pt, pt_bins);
    Data_den_pt_Barrel_fx->Sumw2();
    TH1F* Data_num_pt_Endcap_fx = new TH1F("Data_num_pt_Endcap_fx", "Data_num_pt_Endcap_fx", binnum_pt, pt_bins);
    Data_num_pt_Endcap_fx->Sumw2();
    TH1F* Data_den_pt_Endcap_fx = new TH1F("Data_den_pt_Endcap_fx", "Data_den_pt_Endcap_fx", binnum_pt, pt_bins);
    Data_den_pt_Endcap_fx->Sumw2();
    
    TH1F* Data_num_eta = new TH1F("Data_num_eta", "Data_num_eta", 50, -3, 3);
    TH1F* Data_den_eta = new TH1F("Data_den_eta", "Data_den_eta", 50, -3, 3);
    TH1F* Data_num_eta_Barrel = new TH1F("Data_num_eta_Barrel", "Data_num_eta_Barrel", 50, -3, 3);
    TH1F* Data_den_eta_Barrel = new TH1F("Data_den_eta_Barrel", "Data_den_eta_Barrel", 50, -3, 3);
    TH1F* Data_num_eta_Endcap = new TH1F("Data_num_eta_Endcap", "Data_num_eta_Endcap", 50, -3, 3);
    TH1F* Data_den_eta_Endcap = new TH1F("Data_den_eta_Endcap", "Data_den_eta_Endcap", 50, -3, 3);
    
    TH1F* Data_num_mass_log = new TH1F("Data_num_mass_log", "Data_num_mass_log", NMBINS, logMbins);
    TH1F* Data_num_mass_log_BB = new TH1F("Data_num_mass_log_BB", "Data_num_mass_log_BB", NMBINS, logMbins);
    TH1F* Data_num_mass_log_BE = new TH1F("Data_num_mass_log_BE", "Data_num_mass_log_BE", NMBINS, logMbins);
    
    TH1F* Data_den_mass_log = new TH1F("Data_den_mass_log", "Data_den_mass_log", NMBINS, logMbins);
    TH1F* Data_den_mass_log_BB = new TH1F("Data_den_mass_log_BB", "Data_den_mass_log_BB", NMBINS, logMbins);
    TH1F* Data_den_mass_log_BE = new TH1F("Data_den_mass_log_BE", "Data_den_mass_log_BE", NMBINS, logMbins);
    
    TH1F* num_Data_transverse_mass = new TH1F("num_Data_transverse_mass", "num_Data_transverse_mass", 50, 0, 500);
    num_Data_transverse_mass->Sumw2();
    TH1F* num_Data_dz = new TH1F("num_Data_dz", "num_Data_dz", 50, 0, 10);
    TH1F* num_Data_met_pt = new TH1F("num_Data_met_pt", "num_Data_met_pt", 100, 0, 1000);
    num_Data_met_pt->Sumw2();
    TH1F* num_Data_met_phi = new TH1F("num_Data_met_phi", "num_Data_met_phi", 20, -3, 3);
    
    TH1F* den_Data_transverse_mass = new TH1F("den_Data_transverse_mass", "den_Data_transverse_mass", 50, 0, 500);
    den_Data_transverse_mass->Sumw2();
    TH1F* den_Data_dz = new TH1F("den_Data_dz", "den_Data_dz", 50, 0, 10);
    TH1F* den_Data_met_pt = new TH1F("den_Data_met_pt", "den_Data_met_pt", 100, 0, 1000);
    den_Data_met_pt->Sumw2();
    TH1F* den_Data_met_phi = new TH1F("den_Data_met_phi", "den_Data_met_phi", 20, -3, 3);
    
    
    ///////////////////////////////////////////////////////////////////////////////////////////
    
    TH1F* total_num_pt_Barrel = new TH1F("total_num_pt_Barrel", "total_num_pt_Barrel", binnum_pt, pt_bins);
    total_num_pt_Barrel->Sumw2();
    TH1F* total_den_pt_Barrel = new TH1F("total_den_pt_Barrel", "total_den_pt_Barrel", binnum_pt, pt_bins);
    total_den_pt_Barrel->Sumw2();
    TH1F* total_num_pt_Endcap = new TH1F("total_num_pt_Endcap", "total_num_pt_Endcap", binnum_pt, pt_bins);
    total_num_pt_Endcap->Sumw2();
    TH1F* total_den_pt_Endcap = new TH1F("total_den_pt_Endcap", "total_den_pt_Endcap", binnum_pt, pt_bins);
    total_den_pt_Endcap->Sumw2();
    TH1F* FR_pt_Endcap = new TH1F("FR_pt_Endcap", "FR_pt_Endcap", binnum_pt, pt_bins);
    FR_pt_Endcap->Sumw2();
    TH1F* FR_pt_Barrel = new TH1F("FR_pt_Barrel", "FR_pt_Barrel", binnum_pt, pt_bins);
    FR_pt_Barrel->Sumw2();
    ...
    for(int j=0; j<mc; j++){
        ...
        for(int p=0; p<ne ;p++){
            ...
            //mt and MET for denominator events
            if(
               //lep0
               (lep_isTrackerMuon[0]==1 &&
                lep_isGlobalMuon[0]==1 &&
                fabs(lep_dB[0]) < 0.2 &&
                lep_glb_numberOfValidPixelHits[0] > 0.0 &&
                lep_glb_numberOfValidTrackerLayers[0] > 5.0) ||
               //lep1
               (lep_isTrackerMuon[1]==1 &&
                lep_isGlobalMuon[1]==1 &&
                fabs(lep_dB[1]) < 0.2 &&
                lep_glb_numberOfValidPixelHits[1] > 0.0 &&
                lep_glb_numberOfValidTrackerLayers[1] > 5.0)
               ){
                ...
                if(j==15 /*&& mt<35 && fabs(lep_tk_dz[n]) < 1.0*/){
                    ...
                    den_Wjets_transverse_mass->Fill(mt, weight[j]*Z_peak);
                    den_Wjets_met_pt->Fill(met_pt, weight[j]*Z_peak);
                    ...
                    den_Zjets_transverse_mass->Fill(mt, weight[j]*Z_peak);
                    den_Zjets_met_pt->Fill(met_pt, weight[j]*Z_peak);
                    ...
                    den_ttbar_transverse_mass->Fill(mt, weight[j]*Z_peak);
                    den_ttbar_met_pt->Fill(met_pt, weight[j]*Z_peak);
                    ...
                    den_WW_transverse_mass->Fill(mt, weight[j]*Z_peak);
                    den_WW_met_pt->Fill(met_pt, weight[j]*Z_peak);
                    ...
                    den_WZ_transverse_mass->Fill(mt, weight[j]*Z_peak);
                    den_WZ_met_pt->Fill(met_pt, weight[j]*Z_peak);
                    ...
                    den_ZZ_transverse_mass->Fill(mt, weight[j]*Z_peak);
                    den_ZZ_met_pt->Fill(met_pt, weight[j]*Z_peak);
                    ...
                    den_tW_transverse_mass->Fill(mt, weight[j]*Z_peak);
                    den_tW_met_pt->Fill(met_pt, weight[j]*Z_peak);
                    
                }
                
                else if(j==22 /*&& mt<35 && fabs(lep_tk_dz[n]) < 1.0*/){
                    
                    den_Wantitop_transverse_mass->Fill(mt, weight[j]*Z_peak);
                    den_Wantitop_met_pt->Fill(met_pt, weight[j]*Z_peak);
                    ...
                    den_dy_transverse_mass->Fill(mt, weight[j]*Z_peak);
                    den_dy_met_pt->Fill(met_pt, weight[j]*Z_peak);
                    ...
                    den_qcd_transverse_mass->Fill(mt, weight[j]*Z_peak);
                    den_qcd_met_pt->Fill(met_pt, weight[j]*Z_peak);
            ...
            for(int n=0; n<2; n++){
                ...
                if(
                   ...
                   //lep_triggerMatchPt[n] > 50.0
                    ...
                    if(lep_pt[n]>=2500.0 && lep_pt[n]<=4000.0){
                        std::cout<<"den"<<" "<<MC_samples[j]<<"   "<<run<<"   "<<lumi<<"  "<<event<<" "<<lep_pt[n]<<std::endl;
                    }
                    ...
                    if(j==15 /*&& mt<35 && fabs(lep_tk_dz[n]) < 1.0*/){
                        ...
                        if(fabs(lep_eta[n]) < 1.2){
                            ...
                            Wjets_den_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                            
                            Wjets_den_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                        }
                        else {
                            Wjets_den_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                            Wjets_den_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                       ...
                       */
                        ...
                        if(fabs(lep_eta[n]) < 1.2){
                            ...
                            Zjets_den_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                            
                            Zjets_den_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                        }
                        else {
                            Zjets_den_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                            Zjets_den_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                        ...
                        ttbar_den_eta->Fill(lep_eta[n], weight[j]*Z_peak);
                        
                        
                        if(fabs(lep_eta[n]) < 1.2){
                            ttbar_den_pt_Barrel->Fill(lep_pt[n], weight[j]*Z_peak_BB);
                            ttbar_den_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                            
                            ttbar_den_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                        }
                        else {
                            ttbar_den_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                            ttbar_den_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                            
                            ttbar_den_eta_Endcap->Fill(lep_eta[n], weight[j]*Z_peak_BE);
                        }
                        ...
                        if(fabs(lep_eta[n]) < 1.2){
                            ...
                            WW_den_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                            
                            WW_den_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                        }
                        else {
                            WW_den_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                            WW_den_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                        ...
                        if(fabs(lep_eta[n]) < 1.2){
                            ...
                            WZ_den_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                            
                            WZ_den_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                        }
                        else {
                            WZ_den_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                            WZ_den_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                        ...
                        if(fabs(lep_eta[n]) < 1.2){
                            ...
                            ZZ_den_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                            
                            ZZ_den_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                        }
                        else {
                            ZZ_den_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                            ZZ_den_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                        ...
                        if(fabs(lep_eta[n]) < 1.2){
                            ...
                            tW_den_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                            
                            Wjets_den_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                        }
                        else {
                            tW_den_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                            tW_den_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                        ...
                        if(fabs(lep_eta[n]) < 1.2){
                            ...
                            Wantitop_den_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                            
                            Wantitop_den_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                        }
                        else {
                            Wantitop_den_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                            Wantitop_den_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                        ...
                        dy_den_eta->Fill(lep_eta[n], weight[j]*Z_peak);
                        
                        
                        if(fabs(lep_eta[n]) < 1.2){
                            dy_den_pt_Barrel->Fill(lep_pt[n], weight[j]*Z_peak_BB);
                            dy_den_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                            
                            dy_den_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                        }
                        else {
                            dy_den_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                            dy_den_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                            
                            dy_den_eta_Endcap->Fill(lep_eta[n], weight[j]*Z_peak_BE);
                        }
                        ...
                        if(fabs(lep_eta[n]) < 1.2){
                            ...
                            qcd_den_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                            
                            qcd_den_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                        }
                        else {
                            qcd_den_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                            qcd_den_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                    ...
                    if(
                       ...
                       //fabs(lep_tk_dz[n]) < 1.0
                        ...
                        if(lep_pt[n]>=2500.0 && lep_pt[n]<=4000.0 ){
                            std::cout<<"num"<<" "<<MC_samples[j]<<"   "<<run<<"   "<<lumi<<"  "<<event<<" "<<lep_pt[n]<<std::endl;
                        }
                        ...
                        if(j==15 /*&& mt<35 && fabs(lep_tk_dz[n]) < 1.0*/){
                            ...
                            if(fabs(lep_eta[n]) < 1.2){
                                ...
                                Wjets_num_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                                
                                Wjets_num_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                            }
                            else {
                                Wjets_num_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                                Wjets_num_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                            ...
                            if(fabs(lep_eta[n]) < 1.2){
                                ...
                                Zjets_num_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                                
                                Zjets_num_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                            }
                            else {
                                Zjets_num_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                                Zjets_num_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                            ...
                            ttbar_num_eta->Fill(lep_eta[n], weight[j]*Z_peak);
                            
                            
                            if(fabs(lep_eta[n]) < 1.2){
                                ttbar_num_pt_Barrel->Fill(lep_pt[n], weight[j]*Z_peak_BB);
                                ttbar_num_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                                
                                ttbar_num_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                            }
                            else {
                                ttbar_num_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                                ttbar_num_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                                
                                ttbar_num_eta_Endcap->Fill(lep_eta[n], weight[j]*Z_peak_BE);
                            }
                            ...
                            if(fabs(lep_eta[n]) < 1.2){
                                ...
                                WW_num_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                                
                                WW_num_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                            }
                            else {
                                WW_num_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                                WW_num_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                            ...
                            if(fabs(lep_eta[n]) < 1.2){
                                ...
                                WZ_num_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                                
                                WZ_num_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                            }
                            else {
                                WZ_num_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                                WZ_num_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                            ...
                            if(fabs(lep_eta[n]) < 1.2){
                                ...
                                ZZ_num_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                                
                                ZZ_num_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                            }
                            else {
                                ZZ_num_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                                ZZ_num_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                            ...
                            if(fabs(lep_eta[n]) < 1.2){
                                ...
                                tW_num_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                                
                                tW_num_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                            }
                            else {
                                tW_num_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                                tW_num_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                            ...
                            if(fabs(lep_eta[n]) < 1.2){
                                ...
                                Wantitop_num_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                                
                                Wantitop_num_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                            }
                            else {
                                Wantitop_num_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                                Wantitop_num_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                            ...
                            dy_num_eta->Fill(lep_eta[n], weight[j]*Z_peak);
                            
                            
                            if(fabs(lep_eta[n]) < 1.2){
                                dy_num_pt_Barrel->Fill(lep_pt[n], weight[j]*Z_peak_BB);
                                dy_num_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                                
                                dy_num_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                            }
                            else {
                                dy_num_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                                dy_num_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
                                
                                dy_num_eta_Endcap->Fill(lep_eta[n], weight[j]*Z_peak_BE);
                            }
                            ...
                            if(fabs(lep_eta[n]) < 1.2){
                                ...
                                qcd_num_pt_Barrel_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BB);
                                
                                qcd_num_eta_Barrel->Fill(lep_eta[n], weight[j]*Z_peak_BB);
                            }
                            else {
                                qcd_num_pt_Endcap->Fill(lep_pt[n], weight[j]*Z_peak_BE);
                                qcd_num_pt_Endcap_fx->Fill(lep_pt[n], lep_pt[n]*weight[j]*Z_peak_BE);
        ...
        for ( int p=0; p<ne ;p++) {
            ...
            if(
               ...
               (lep_isTrackerMuon[1]==1 &&
                ...
                den_Data_transverse_mass->Fill(mt);
                den_Data_met_pt->Fill(met_pt);
            ...
            for(int n=0; n<2; n++){
                ...
                if(
                   ...
                   //lep_triggerMatchPt[n] > 50.0
                    ...
                    if(lep_pt[n]>=2500.0 && lep_pt[n]<=4000.0){
                        std::cout<<"den"<<" "<<DATA_samples[j]<<"   "<<run<<"   "<<lumi<<"  "<<event<<" "<<lep_pt[n]<<std::endl;
                    }
                    ...
                    if(fabs(lep_eta[n]) < 1.2){
                        ...
                        Data_den_pt_Barrel_fx->Fill(lep_pt[n],lep_pt[n]);
                        
                        Data_den_eta_Barrel->Fill(lep_eta[n]);
                    }
                    else {
                        Data_den_pt_Endcap->Fill(lep_pt[n]);
                        Data_den_pt_Endcap_fx->Fill(lep_pt[n],lep_pt[n]);
                    ...
                    if(
                       ...
                       //fabs(lep_tk_dz[n]) < 1.0
                        ...
                        num_DATA[j][0]++;
                         ...
                         if(lep_pt[n]>=2500.0 && lep_pt[n]<=4000.0 ){
                         std::cout<<"num"<<" "<<DATA_samples[j]<<"   "<<run<<"   "<<lumi<<"  "<<event<<" "<<lep_pt[n]<<std::endl;
                         }
                        ...
                        if(fabs(lep_eta[n]) < 1.2){
                            ...
                            Data_num_pt_Barrel_fx->Fill(lep_pt[n],lep_pt[n]);
                            
                            Data_num_eta_Barrel->Fill(lep_eta[n]);
                        }
                        else {
                            Data_num_pt_Endcap->Fill(lep_pt[n]);
                            Data_num_pt_Endcap_fx->Fill(lep_pt[n],lep_pt[n]);
...
void DrawPlot(TH1F* qcd, TH1F* Wjets, TH1F* Zjets, TH1F* ttbar, TH1F* WW, TH1F* WZ, TH1F* ZZ, TH1F* tW, TH1F* Wantitop, TH1F* dy, TH1F* DATA, THStack* DATA_MC, TString title, TString name, bool logx){
    ...
    TCanvas *c3 = new TCanvas("DATA_MC", "DATA_MC", 1000, 800);
    c3->cd();
    ...
    if(logx){
        const Int_t n = 7;
        ratio->GetXaxis()->SetLabelSize(15);
        char *pt[n] = {"50","200","500","1250", "1750", "3000","4000"};
        //char *pt[n] = {"50","200","500","1000", "1500", "2500","4000"};
        //char *pt[n] = {"50","200","400","600","900","1200", "1500", "1900", "2300", "2700", "3100", "3500"};
        Float_t x, y;
...
void RatePlot(TH1F* Wjets_den, TH1F* Zjets_den, TH1F* ttbar_den, TH1F* WW_den, TH1F* WZ_den, TH1F* ZZ_den, TH1F* tW_den, TH1F* Wantitop_den, TH1F* dy_den, TH1F* Data_den, TH1F* Wjets_num, TH1F* Zjets_num, TH1F* ttbar_num, TH1F* WW_num, TH1F* WZ_num, TH1F* ZZ_num, TH1F* tW_num, TH1F* Wantitop_num, TH1F* dy_num, TH1F* qcd_den, TH1F* qcd_num, TH1F* Data_num, TString title, TString name){
    ...
    TCanvas *c3 = new TCanvas("rate", "rate", 1000, 800);
    c3->cd();
    
    
    
    TH1F* total_den = (TH1F*) Data_den->Clone();
    total_den->Sumw2();
    TH1F* MC_den = (TH1F*) Wjets_den->Clone();
    MC_den->Sumw2();
    MC_den->Add(dy_den);
    ...
    TH1F* total_num = (TH1F*) Data_num->Clone();
    total_num->Sumw2();
    TH1F* MC_num = (TH1F*) Wjets_num->Clone();
    MC_num->Sumw2();
    MC_num->Add(dy_num);
    ...
    TH1F* FR_pt= (TH1F*) total_num->Clone();
    FR_pt->Sumw2();
    ...
    double dn=0.0, mn=0.0, dd=0.0, md=0.0 ;
    double num=0.0;
    double num_err = 0.0;
    double den=0.0;
    double den_err = 0.0;
    ...
    for(int i=1; i<=binnum_pt; i++){
        ...
        dn = Data_num->GetBinContent(i);
        dd = Data_den->GetBinContent(i);
        mn = MC_num->GetBinError(i)*MC_num->GetBinError(i);
        md = MC_den->GetBinError(i)*MC_den->GetBinError(i);
        ...
        double err = r * sqrt(((dn+mn)/(num*num)) + ((dd+md)/(den*den)) - 2*(dn+mn)/(num*den));
        
        std::cout<<i<<" "<<num<<"   "<<total_num->GetBinError(i)<<"   "<<den<<"   "<<total_den->GetBinError(i)<<"   "<<dd<<"    "<<Data_den->GetBinError(i)<<"  "<<md<<"    "<<MC_den->GetBinError(i)<<"    "<<r<<" "<<err<<std::endl;
...
void QCDPlot(TH1F* qcd_den, TH1F* qcd_num, TString name){
    ...
    TH1F* qcd_d = (TH1F*) qcd_den->Clone();
    qcd_d->Sumw2();
    TH1F* qcd_n = (TH1F*) qcd_num->Clone();
    qcd_n->Sumw2();
    qcd_n->Divide(qcd_d);
